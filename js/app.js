...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var usersOS = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.detectUsersOS)();
      ...
      if (usersOS === 'iOS' || usersOS === 'Macintosh') document.body.classList.add('body--safari_state');
    }
  }]);
...
var Header = /*#__PURE__*/function () {
  function Header() {
    ...
    this.$langBtn = document.querySelector(this.SELECTORS.langBtn);
    this.$toTopBtn = document.querySelector(this.SELECTORS.toTopBtn);
  ...
  _createClass(Header, [{
    ...
    get: function get() {
      return {
        ...
        langParent: '.header_lang',
        langBtn: '.header_lang__current',
        toTopBtn: '.header_button',
        menu: '.header_menu'
      };
    }
  }, {
    ...
    get: function get() {
      return {
        ...
        languagesOpenState: 'header_lang--open_state'
      };
    }
  }, {
    key: "openMenu",
    ...
    value: function headerScroll(windowScrollTop) {
      if (windowScrollTop > 200 && !this.$body.classList.contains(this.CLASSNAMES.bodyScrollState)) {
      ...
      if (window.innerWidth >= utils_constants__WEBPACK_IMPORTED_MODULE_1__.GLOBAL_VARS.mediaPoint1 && this.$menu) {
        if (windowScrollTop <= this.$header.clientHeight) {
          this.$menu.style = "transform: translateY(-".concat(windowScrollTop, "px)");
        } else {
          this.$menu.style = "transform: translateY(-".concat(this.$header.clientHeight, "px)");
        }
      }
    }
  }, {
    ...
    value: function init() {
      ...
      if (typeof this.$header !== 'undefined' && this.$header != null) {
        ...
        document.addEventListener('click', function (e) {
          var openStateClass = _this.CLASSNAMES.languagesOpenState;

          var isOpen = _this.$langParent.classList.contains(openStateClass);

          if (e.target === _this.$toTopBtn || e.target.closest(_this.SELECTORS.toTopBtn)) {
          ...
          if (isOpen) {
            if (!e.target.closest(_this.SELECTORS.langParent) || e.target === _this.$langBtn) {
              _this.$langParent.classList.remove(openStateClass);
            }
          } else if (e.target === _this.$langBtn) {
            _this.$langParent.classList.add(openStateClass);
          }
        });
      }
    }
...
var pageWidgetArray = [];
var pagesArray = ["contact.pug","ecosystem.pug","index.pug","partners.pug","philosophy.pug"];
...
/***/ "./src/images/icons/sprite_icons/arrow_t.svg":
/*!***************************************************!*\
  !*** ./src/images/icons/sprite_icons/arrow_t.svg ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "arrow_t-usage",
      viewBox: "0 0 13.611 14.487",
      url: "/images/sprite/" + "sprite.svg#arrow_t-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/close_icon.svg":
/*!******************************************************!*\
  !*** ./src/images/icons/sprite_icons/close_icon.svg ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "close_icon-usage",
      viewBox: "0 0 12.4 12.8",
      url: "/images/sprite/" + "sprite.svg#close_icon-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/cross.svg":
/*!*************************************************!*\
  !*** ./src/images/icons/sprite_icons/cross.svg ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "cross-usage",
      viewBox: "0 0 12.45 12.81",
      url: "/images/sprite/" + "sprite.svg#cross-usage",
      toString: function () {
        return this.url;
      }
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "pause-usage",
      viewBox: "0 0 9 14.47",
      url: "/images/sprite/" + "sprite.svg#pause-usage",
      toString: function () {
        return this.url;
      }
    });
...
/***/ "./src/images/icons/sprite_icons/quote_icon.svg":
/*!******************************************************!*\
  !*** ./src/images/icons/sprite_icons/quote_icon.svg ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      id: "quote_icon-usage",
      viewBox: "0 0 21 14",
      url: "/images/sprite/" + "sprite.svg#quote_icon-usage",
      toString: function () {
        return this.url;
      }
    });
...
var map = {
	...
	"./arrow_t.svg": "./src/images/icons/sprite_icons/arrow_t.svg",
	"./close_icon.svg": "./src/images/icons/sprite_icons/close_icon.svg",
	"./cross.svg": "./src/images/icons/sprite_icons/cross.svg",
	...
	"./quote_icon.svg": "./src/images/icons/sprite_icons/quote_icon.svg"
};
...
var map = {
	...
	"./PhilosophyPage": [
		...
		"vendors-node_modules_gsap_ScrollTrigger_js",
		"src_js_pages_PhilosophyPage_js"
	],
	"./PhilosophyPage.js": [
		"./src/js/pages/PhilosophyPage.js",
		"vendors-node_modules_gsap_ScrollTrigger_js",
